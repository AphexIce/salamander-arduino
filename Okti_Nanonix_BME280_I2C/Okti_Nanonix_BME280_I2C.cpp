...
*/
/**************************************************************************/
float BME280_I2C::readAltitude(float seaLevelhPa)
{
  ...
  return 44330.0 * (1.0 - pow(atmospheric / seaLevelhPa, 0.1903));
}
...
*/
/**************************************************************************/
float BME280_I2C::seaLevelForAltitude(float altitude, float atmospheric)
{
